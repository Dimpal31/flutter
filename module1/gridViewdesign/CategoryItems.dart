                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.only(right: 11.0,bottom: 4.0),
                        child: Stack(
                          children: [
                           // Image.asset("assets/images/image.png",height: 80,width: 80,),
                            Image.network('https://static.vecteezy.com/system/resources/thumbnails/000/964/198/small/fast-food-meal-set.jpg',height: 80,width: 80,),
                            Positioned(
                              bottom: 0,right: 0,
                              child: CircleAvatar(
